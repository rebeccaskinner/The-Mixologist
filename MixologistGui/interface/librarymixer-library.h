...
class LibraryMixerLibraryManager {
    ...
    public:
        //Merges an xml list of item to the existing library.xml.  Functions assumes that they are in the same order,
        //with newest first.
        ...
        static void completedDownloadLendCheck(int item_id, QStringList paths, QStringList hashes, QList<int> filesizes);
