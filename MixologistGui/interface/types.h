...
class LibraryMixerItem: public QObject {
Q_OBJECT
...
public:
    ...
    LibraryMixerItem(QDomNode &domNode);
    /* Deleting a LibraryMixerItem will also remove its domNode from the xml tree. */
    ~LibraryMixerItem();
    ...
    bool itemState(ItemState newState);
